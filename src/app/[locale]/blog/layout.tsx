...
export async function generateMetadata({
  ...
  const title = `${dict.blog.title} (200 Guides) | nhiep.net`;
  const desc = `${dict.blog.subtitle} - Cẩm nang kinh nghiệm, bí quyết chụp ảnh cưới, quay phim, flycam và hướng dẫn du lịch Đà Nẵng, Huế, Quảng Trị, Nha Trang.`;
