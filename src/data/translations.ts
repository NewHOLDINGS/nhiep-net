...
export const DICTIONARY = {
  vi: {
    ...
    booking: {
      ...
      submitBooking: 'Hoàn Tất & Gửi Yêu Cầu Đặt Lịch',
      nextStep: 'Tiếp Tục',
      prevStep: 'Quay Lại',
  ...
  en: {
    ...
    booking: {
      ...
      submitBooking: 'Confirm & Submit Reservation',
      nextStep: 'Continue',
      prevStep: 'Previous',
