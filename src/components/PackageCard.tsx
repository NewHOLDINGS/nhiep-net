...
import { Check, Clock, Users, Camera, Sparkles, ArrowRight, ShieldCheck } from 'lucide-react';
...
export default function PackageCard({
  ...
  return (
    <div className={`relative rounded-2xl overflow-hidden glass-panel glass-panel-hover flex flex-col justify-between border ${
      ...
      <div className="p-5 flex-1 flex flex-col justify-between space-y-4">
        ...
        <div className="pt-4 border-t border-surface-border flex items-center justify-between gap-3">
          ...
          <Link
            ...
            className="px-4 py-2.5 rounded-xl bg-brand hover:bg-brand-400 text-black font-extrabold text-xs flex items-center gap-1.5 shadow-glow transition-all hover:scale-105 shrink-0"
          >
